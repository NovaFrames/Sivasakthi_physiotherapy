    ...
    return (
        <Box>
            ...
            <Container maxWidth="lg">
                ...
                <Section title="Detailed Physiotherapy Specialties">
                    {[
                        ...
                        <Grid container spacing={4} alignItems="center" sx={{ mb: 6 }} key={i}>
                            ...
                            <Grid size={{ xs: 12, md: 6 }}>
                                <Typography variant="h6" fontWeight={700} sx={{ mb: 1, color: colors.primary }}>
                                    {spec.title}
                                </Typography>
                ...
                <Section title="Advanced Physiotherapy Approaches & Concepts">
                    ...
                    <Grid container spacing={3}>
                        {[
                            {
                                category: "Manual Therapy Concepts",
                            ...
                            },
                            {
                                ...
                                items: ["Dry Needling", "Kinesio Taping", "Laser", "EMG Biofeedback", "Shockwave Therapy"],
                            },
                        ].map((category, i) => (
                            <Grid key={i} size={{ xs: 12, sm: 6 }}>
                                <Card sx={{ p: 3, borderRadius: 3, backgroundColor: colors.lightGray }}>
                                    <Typography fontWeight={700} sx={{ mb: 1, color: colors.primary }}>
                                        {category.category}
                                    </Typography>
                                    <ul>
            ...
            >
                ...
                <Button
                    variant="contained"
                    sx={{ backgroundColor: colors.accent, color: "#fff", px: 5 }}
